...
All 150 runs complete.

| 240 Hz scenario | zcrudp p50 / p99 | ENet p50 / p99 | ENet-zpl p50 / p99 | UDP payload bytes (zcrudp / ENet / ENet-zpl) |
| --- | ---: | ---: | ---: | ---: |
| No loss | 10 / 10 ms | 10 / 10 ms | 10 / 10 ms | 38,400 / 57,970 / 57,942 |
| 1% loss + jitter | 13 / 46 ms | 13 / 47 ms | 13 / 48 ms | 40,124 / 58,692 / 58,672 |
| 5% loss + jitter | 14 / 57 ms | 15 / 167 ms | 14 / 378 ms | 47,248 / 62,096 / 62,596 |

Values are medians over five seeds. The byte counts include both directions and
retries. At 5% loss the adaptive profile has lower p99 than ENet and ENet-zpl here, while using
substantially less UDP-payload traffic.
